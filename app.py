...
# Custom Modern Clean Theme & Zero-Margin Layout
st.markdown("""
<style>
...
# Modern Clean SaaS Top Header (Zero Excess Margin)
st.markdown("""
...
if nav_page == "🏠 Live Predictor":
    ...
    st.markdown('<div class="card-title">🎯 Stock Selection & Real-Time Prediction Command</div>', unsafe_allow_html=True)
    ...
    st.markdown('<div class="card-box">', unsafe_allow_html=True)
    st.markdown(f'<div class="card-title">📈 Price Action & AI Forecast Target - {company_title}</div>', unsafe_allow_html=True)
    ...
    # Summary Grid
    st.markdown('<div class="card-box">', unsafe_allow_html=True)
    st.markdown('<div class="card-title">📋 Summary of Forecast Readings</div>', unsafe_allow_html=True)
...
# ==========================================
    ...
    st.markdown('<div class="card-box">', unsafe_allow_html=True)
    st.markdown(f'<div class="card-title">📊 Multi-Indicator Technical Analysis: {company_title}</div>', unsafe_allow_html=True)
...
# ==========================================
    ...
    st.markdown('<div class="card-box">', unsafe_allow_html=True)
    st.markdown('<div class="card-title">🤖 Machine Learning Model Inspector & Performance</div>', unsafe_allow_html=True)
    ...
    st.markdown('<div class="card-box">', unsafe_allow_html=True)
    st.markdown('<div class="card-title">🧪 Interactive What-If Scenario Simulator</div>', unsafe_allow_html=True)
...
# ==========================================
    ...
    st.markdown('<div class="card-box">', unsafe_allow_html=True)
    st.markdown('<div class="card-title">⚙️ Machine Learning Pipeline Architecture</div>', unsafe_allow_html=True)
...
# ==========================================
    ...
    st.markdown('<div class="card-box">', unsafe_allow_html=True)
    st.markdown('<div class="card-title">ℹ️ Project Overview & Documentation</div>', unsafe_allow_html=True)
    st.markdown("""
